...
<p>
    I heard about this poem from an associated song by Phil Ochs - <a
        href="https://youtu.be/sKZjmvWmfEM">Yukon Plane Crash</a
    >
    which uses a lot of it. The song's about the survival of Ralph Flores and Helen
    Klaben who in 1963 lived for seven weeks in the freezing cold with very little
    resources after a plane crash. The poem was published in 1907 as shown in
    <a
        href="https://en.wikisource.org/wiki/The_Spell_of_the_Yukon_and_Other_Verses/The_Law_of_the_Yukon"
    >
        wikisource
    </a>
    I have reproduced it here since it's public domain and I think it's neat.
</p>
<pre>
